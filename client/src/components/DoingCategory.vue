<template>
  <div class="col-12 col-lg-6 col-xl-3" id="doing-category">
                        ...
                        <div class="card card-border-danger">
                            ...
                            <div class="card-header">
                                ...
                                <h6 class="card-subtitle" id="doing-sub">{{ numDoing }} Tasks on progress, dont give
                                    up!</h6>
                            </div>
...
export default {
    name: 'DoingCategory',
    props: ['numDoing', 'doing', 'taskId', 'task', 'baseURL'],
    components: {
        draggable
    },
    methods: {
