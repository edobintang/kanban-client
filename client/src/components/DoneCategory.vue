<template>
  <div class="col-12 col-lg-6 col-xl-3" id="done-category">
                        ...
                        <div class="card card-border-success">
                            ...
                            <div class="card-header">
                                ...
                                <h6 class="card-subtitle" id="done-sub">{{ numDone }} Tasks complete, well done!</h6>
                            </div>
...
export default {
    name: 'DoneCategory',
    props: ['numDone', 'done', 'taskId', 'task', 'baseURL'],
    components: {
        draggable
    },
    methods: {
